                    ...
                    <div class="box-body">
                        ...
                        <div class="col-lg-6 col-sm-6 col-sm-11 col-xs-12">
                            <div class="form-group">
                                ...
                                <input name="description" value="{{old('description', $brand->description)}}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-sm-6 col-sm-11 col-xs-12">
                            ...
                            <div class="form-group">
                                <img width="250px" height="250" src="{{Storage::url($brand->logo)}}">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12">
                <div class="box-body">
                    ...
                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                        <button class="btn btn-primary btn-block">Actualizar marca</button>
                    </div>
                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
